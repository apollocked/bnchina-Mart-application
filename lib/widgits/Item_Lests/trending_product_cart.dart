 ...
 Map<String, dynamic> product;
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
    Navigator.push(context, MaterialPageRoute(builder: (context){return ProductItem(product: product);}));
  },
                                          ...
                                          child: Stack(
                                            children: [
                                              ...
                                              , Positioned(right: 0,bottom: 0,
                                                child: FloatingActionButton.small( heroTag: "${product['imgPath']}",
                                                onPressed: (){
