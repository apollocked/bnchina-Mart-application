...
Map<String, dynamic> product;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            AspectRatio(aspectRatio: 1/1
              ...
              child: Image.asset(product["imgPath"], height: 150,fit: BoxFit.cover,),),),
              const SizedBox(height: 15,),
            CategoryText(category: product["category"])
              ,const SizedBox(height: 15,)
              ,
              Text(product["name"],style: TextStyle(fontFamily: 'popins',color: textColor, fontSize: 25),),
              const SizedBox(height: 10,),
              Text(product["details"],style: TextStyle( fontSize: 18,fontFamily: 'popins',color: textColor),),
              const SizedBox(height: 10,),
                Text.rich(TextSpan(
      ...
      bottomSheet: Container(color: backgroundColor,
        child: Padding(
