...
class BasketCard extends StatefulWidget {
   BasketCard({super.key,required this.product, required this.onMinus,required this.onplus});
                       ...
                       child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        ...
                        Row(
                         ...
                         Text(widget.product["name"],style: 
                          ...
                          Text(widget.product["details"],style: 
                         TextStyle(fontSize:10,fontFamily: 'popins',color: textColor
                         , fontWeight: FontWeight.bold),),   
                              Text.rich(TextSpan(
                            children: [TextSpan(text:widget.product["totalPrice"].toString(),style: 
                          ...
                          ,SizedBox(height: 30,
                            child: Row(
                              children: [
                                FloatingActionButton(heroTag:"basket m ${widget.product["imgPath"]}",
                            onPressed:
                              widget.onMinus
                             
                            ,backgroundColor: primaryColor,
                            shape: const CircleBorder(),
                            child:  Icon(Icons.remove,size: 19,color:inblack,),),
                               Text("${widget.product["quantity"]}"),
                            FloatingActionButton(heroTag:"basket p ${widget.product["imgPath"]}",
                            onPressed: 
                             widget.onplus
                            ,backgroundColor: primaryColor,
                            shape: const CircleBorder(),
