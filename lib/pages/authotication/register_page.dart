...
import 'package:bnchinamart/pages/authotication/login_page.dart';
          ...
          body:   SingleChildScrollView(
           ...
           ,child: Column(
            ...
            children: [
                ...
                Text("Wellcome ",style: TextStyle(color: textColor,fontSize:32,fontWeight: FontWeight.bold),),
                  const SizedBox(height: 10,),
                  Form(key: _form
                    , child:
                   Column(
                    children: [
                      ...
                      CustomField(onvalidad:  (value) {
                         ...
                         isval=true;
                         return null;}, onsave:   (newValue) {
                          username=newValue;
                        }, path: usernameIcon, name: "Username")
                      ,const SizedBox(height: 10,),
                      CustomField(onvalidad:   (value) {
                         if(value== null || value.isEmpty) {
                            isval=false;
                      ...
                      ElevatedButton(
                       ...
                       login(context);
                        ...
                        ,Row(mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                             Text("Already have account?",style: TextStyle(fontSize: 10,color: textColor),),
